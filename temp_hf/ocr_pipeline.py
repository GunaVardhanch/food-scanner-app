...
class AdvancedOCRPipeline:
    ...
    def reader(self):
        if self._reader is None:
            ...
            # Use the directory where models were downloaded during build
            model_dir = os.environ.get('EASYOCR_MODULE_PATH', '/app/easyocr_models')
            self._reader = easyocr.Reader(['en', 'hi', 'mr'], 
                                           gpu=gpu_available, 
